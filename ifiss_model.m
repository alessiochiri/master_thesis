% Wrapper function IFISS - UQLab

function Y_all = ifiss_model(X)
    ...
    for i = 1:N
        ...
        try
            [flowsol, fst, gst, Jnst, Bst] = solve_navier_ifiss(viscosity, 3, 20, 20, 1e-8, 2, ...
                                                        A, B, f, g, xy, mv, bound);
            
            try
                [real_hopf, imag_hopf] = eigenvalueproblem(xy, bound, Jnst, G, Bst, gst);
                ...
                fprintf('  Warning: failure, eigenvalues (%s)\n', ME.message);
                real_hopf = NaN;
                imag_hopf = NaN;
            end
